...
import service from '../services/loainguoidung.service.js'


class LoainguoidungController {
    constructor(service) {
    ...
    insert(req, res) {
        ...
        service.insert(loainguoidung, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const loainguoidung = req.body
        // const id = req.params.id
        service.update(loainguoidung, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new LoainguoidungController(service)