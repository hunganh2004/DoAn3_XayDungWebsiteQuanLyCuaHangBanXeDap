...
import service from '../services/hangsanxuat.service.js'
...
class HangsanxuatController {
    ...
    insert(req, res) {
        const hangsanxuat = req.body
        service.insert(hangsanxuat, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const hangsanxuat = req.body
        // const id = req.params.id
        service.update(hangsanxuat, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new HangsanxuatController(service)