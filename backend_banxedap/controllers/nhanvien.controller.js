...
import service from '../services/nhanvien.service.js'
...
class NhanvienController {
    ...
    insert(req, res) {
        ...
        service.insert(nhanvien, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const nhanvien = req.body
        // const id = req.params.id
        service.update(nhanvien, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new NhanvienController(service)