...
import service from '../services/khachhang.service.js'
...
class KhachhangController {
    constructor(service) {
        ...
        this.getByNguoiDungId = this.getByNguoiDungId.bind(this)
    }
    getByNguoiDungId(req, res) {
        const id = req.params.id
        service.getByNguoiDungId(id, (result) => {
            res.send(result)
        })
    }
    getSearch(req, res) {
    ...
    insert(req, res) {
        ...
        service.insert(khachhang, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const khachhang = req.body
        // const id = req.params.id
        service.update(khachhang, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new KhachhangController(service)