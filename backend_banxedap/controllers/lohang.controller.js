...
import service from '../services/lohang.service.js'


class LohangController {
    constructor(service) {
    ...
    insert(req, res) {
        const lohang = req.body
        service.insert(lohang, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
...
export default new LohangController(service)