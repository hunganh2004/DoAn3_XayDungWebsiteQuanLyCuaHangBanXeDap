...
import service from '../services/sanpham.service.js'
...
class SanphamController {
    constructor(service) {
        ...
        this.getPaginationByCategory = this.getPaginationByCategory.bind(this)
    }
    getSearch(req, res) {
    ...
    getPaginationByCategory(req, res) {
        const categoryId = req.params.categoryId
        const pageSize = parseInt(req.query.pageSize) || 10
        const pageNumber = parseInt(req.query.pageNumber) || 1

        service.getPaginationByCategory(categoryId, pageSize, pageNumber, (result) => {
            res.send(result)
        })
    }
...
export default new SanphamController(service)