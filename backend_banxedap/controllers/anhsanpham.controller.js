...
import service from '../services/anhsanpham.service.js'


class AnhsanphamController {
    constructor(service) {
    ...
    insert(req, res) {
        const anhsanpham = req.body
        service.insert(anhsanpham, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const anhsanpham = req.body
        // const id = req.params.id
        service.update(anhsanpham, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new AnhsanphamController(service)