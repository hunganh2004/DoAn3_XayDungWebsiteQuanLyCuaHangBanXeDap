...
import service from '../services/trangthaidonhang.service.js'
...
class TrangthaidonhangController {
    ...
    insert(req, res) {
        ...
        service.insert(trangthaidonhang, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const trangthaidonhang = req.body
        // const id = req.params.id
        service.update(trangthaidonhang, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new TrangthaidonhangController(service)