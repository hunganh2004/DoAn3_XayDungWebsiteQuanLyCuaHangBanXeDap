...
import service from '../services/khuyenmai.service.js'
...
class KhuyenmaiController {
    ...
    insert(req, res) {
        ...
        service.insert(khuyenmai, (result) => {
            res.send(result)
        })
    }
    update(req, res) {
        const khuyenmai = req.body
        // const id = req.params.id
        service.update(khuyenmai, (result) => {
            res.send(result)
        })
    }
    delete(req, res) {
...
export default new KhuyenmaiController(service)